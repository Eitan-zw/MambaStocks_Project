...
def train_model(trainX, trainy):
    clf = Network(len(trainX[0]), 1) # Initialize the neural network model
    ...
    dimensions = {'in_dim': len(trainX[0]), 'out_dim': 1}
...
trainX, _ = X[:-args.n_test, :], X[-args.n_test:, :]
trainy = y[:-args.n_test]

# Train the model
trained_model = train_model(trainX, trainy)
